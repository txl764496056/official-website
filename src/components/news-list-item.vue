...
.item-time p{font-size: 60px;color:#0099ff;line-height: 55px;}
.item-time span{font-size: 24px;color:#c6c6c6;}
.item:hover{transform: scale(1.05);box-shadow: 0 1px 5px rgba(100,100,100,0.3);}
.item:hover h2{color:#0099ff;}
</style>
